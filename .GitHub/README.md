...
<p align="center">
  <a href="https://dashboard.heroku.com/new?template=https://github.com/TEAM-ISTKHAR/ROOHI">
...
<h1 align="center">─「 ǫᴜɪᴄᴋ sᴇᴛᴜᴘ 」─</h1>
 ...
 6. **📥 ᴄʟᴏɴᴇ ᴛʜᴇ ʀᴇᴘᴏsɪᴛᴏʀʏ**
   ```bash
   git clone https://github.com/TEAM-ISTKHAR/ROOHI && cd ROOHI
   ```
...
<p>©️ 2025-26 ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ ʙʏ <strong>ʀᴏᴏʜɪ ʙᴏᴛs (<a href="https://github.com/TEAM-ISTKHAR">TEAM-ISTKHAR</a>)</strong> 🚀</p>

<p>• ᴛʜɪs <a href="https://github.com/TEAM-ISTKHAR/ROOHI">sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ</a> ɪs ʀᴇʟᴇᴀsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ <strong><a href="https://github.com/TEAM-ISTKHAR/ROOHI/blob/main/LICENSE">MIT LICENSE</a></strong> 📜</p>

...
font = ImageFont.truetype("ISTKHAR/assets/assets/font.ttf", 30)
title_font = ImageFont.truetype("ISTKHAR/assets/assets/font3.ttf", 45)
...
async def get_thumb(videoid):
    ...
    try:
        ...
        draw.text((1280 - text_size[0] - 10, 10), " @SukoonxRobot   ", fill="yellow", font=font)
        line_length = 580

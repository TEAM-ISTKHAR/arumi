...
def _sunburst_thumb(
    ...
    # Fonts
    try:
        f_title   = ImageFont.truetype("ISTKHAR/assets/font.ttf",  82)
        f_channel = ImageFont.truetype("ISTKHAR/assets/font.ttf",  40)
        f_meta    = ImageFont.truetype("ISTKHAR/assets/font.ttf",  34)
        f_time    = ImageFont.truetype("ISTKHAR/assets/font2.ttf", 30)
    except Exception:
...
def _hexagon_thumb(
    ...
    # Fonts
    try:
        f_title = ImageFont.truetype("ISTKHAR/assets/font.ttf",  44)
        f_meta  = ImageFont.truetype("ISTKHAR/assets/font.ttf",  26)
        f_tag   = ImageFont.truetype("ISTKHAR/assets/font2.ttf", 28)
    except Exception:

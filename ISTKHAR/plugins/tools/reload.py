...
from ISTKHAR.utils.database import get_assistant, get_authuser_names, get_cmode
from ISTKHAR.utils.decorators import ActualAdminCB, AdminActual, language
from ISTKHAR.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await ROOHI.stop_stream_force(chat_id)
        except:
            pass
             ...
             [
                 [
                      InlineKeyboardButton(
                         "• 𝖧ᴀᴄᴋᴇᴅ вʏ  •", url=f"https://t.me/ITZZ_ISTKHAR")
                 ]
            ]
         ),
     )
